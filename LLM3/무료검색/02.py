...
# 텍스트 분할(청킹)
text_splitter = RecursiveCharacterTextSplitter(chunk_size=30,chunk_overlap=50)
...
class RelebanveGrade(BaseModel):
    '''문서 관련성 평가 결과'''
...
# 문서 평가용 구조화된 LLM 
grade_llm = llm.with_structured_output(RelebanveGrade)
grade_prompt = ChatPromptTemplate.from_template('''
    당신은 문서 관련성은 평가하는 전문가입니다.
